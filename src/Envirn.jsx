...
<div className='ga'>
    ...
    <Carousel fade>
      ...
      <h1 className= "min" style={{marginTop:"-50px", textAlign:"center"}}>Environmental Issue </h1>
...
Rights Movement-Punjab, Grow-Green Network-Pakistan, NGOs coordination Council.</p2> </p>
    ...
    <div className="About">
      <h1 className="min" style={{fontSize:"28px", backgroundColor:"#ffa500ba", marginLeft:"8%", marginRight: "8%"}}>Working on Environmental Issue</h1>
     <div className="desc">
