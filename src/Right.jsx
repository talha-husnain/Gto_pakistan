...
export const Home = () => {
  return (
    ...
    <Carousel fade>
      ...
      <h1 className= "min" style={{marginTop:"-50px" , textAlign:"center"}}>Human Rights</h1>
...
Rights Movement-Punjab, Grow-Green Network-Pakistan, NGOs coordination Council.</p2> </p>
    ...
    <div className="About">
      <h1 className="min" style={{fontSize:"28px", backgroundColor:"#ffa500ba", marginLeft:"8%", marginRight: "8%"}}>Working on Human Rights</h1>
     <div className="desc">
