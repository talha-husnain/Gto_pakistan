...
<div className='ga'>
    ...
    <Carousel fade>
      ...
      <h1 className= "min" style={{marginTop:"-50px", textAlign:"center", alignItems: "center", alignContent:"center"}}>Disaster Management</h1>
...
Rights Movement-Punjab, Grow-Green Network-Pakistan, NGOs coordination Council.</p2> </p>
    ...
    <div className="About">
      <h1 className="min" style={{fontSize:"28px", backgroundColor:"#ffa500ba", marginLeft:"8%", marginRight: "8%", textAlign:"center"}}>Working on Disaster Management</h1>
     <div className="desc">
